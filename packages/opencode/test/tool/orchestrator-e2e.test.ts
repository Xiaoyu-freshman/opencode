...
import { existsSync, readFileSync, writeFileSync, mkdirSync, readdirSync, unlinkSync, rmSync, mkdtempSync } from "fs"
import { tmpdir } from "os"
import { join } from "path"

// Test configuration
const TEST_HOME = mkdtempSync(join(tmpdir(), "opencode-orchestrator-e2e-"))
const TEST_DIR = join(TEST_HOME, ".config", "opencode")
